// src/app/legal-rights/_components/legal-rights-client.tsx
"use client";
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="language-select-rights" className="font-semibold flex items-center">
            ...
            <div className="space-y-2">
              <Label htmlFor="topic" className="font-semibold">{translate("labels.legalTopic")}</Label>
              <Input
                id="topic"
            ...
            <div className="space-y-2">
              <Label htmlFor="country" className="font-semibold">{translate("labels.countryOptional")}</Label>
              <Input
                id="country"
