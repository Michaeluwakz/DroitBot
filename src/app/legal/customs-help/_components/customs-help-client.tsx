...
// src/app/legal/customs-help/_components/customs-help-client.tsx
"use client";
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="language-select-legal" className="font-semibold flex items-center">
            ...
            <div className="space-y-2">
              <Label htmlFor="procedure-legal" className="font-semibold">{translate("labels.procedureName")}</Label>
              <Input
                id="procedure-legal"
